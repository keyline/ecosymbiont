...
<section class="journal_layout_system">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                <small class="text-danger">Star (*) amrks fields are mandatory</small>
                <form class="row g-3" action="" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="col-md-2">
                        ...
                        {{-- <select class="form-select" aria-label="Default select example" name="userType" id="userType">
                            <option selected value="1">Single User</option>
                    ...
                    <div class="col-md-12">
                        <label for="inputCity" class="form-label">Manusscript <small
                                class="text-danger">*</small></label>
                        <div class="input-group">
