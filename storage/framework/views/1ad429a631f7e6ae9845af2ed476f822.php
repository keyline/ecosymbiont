...
<marquee width="100%" behavior='scroll' direction='left' scrollamount='5' onmouseover='this.stop()' onmouseout='this.start()' style="background: #ccc;">
    <?php echo $scrollNotice->content; ?>

</marquee>
<?php /**PATH /home/keyline1/public_html/dev/aliahjournal.keylines.net.in/resources/views/front/elements/beforeheader.blade.php ENDPATH**/ ?>