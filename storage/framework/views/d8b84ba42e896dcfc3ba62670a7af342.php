            ...
            <tbody>
              <?php if($rows){ $sl=1; foreach($rows as $row){?>
                <tr>
                  ...
                  <td>
                    <?php if($row->icon != ''){?>
                      <img src="<?=env('UPLOADS_URL').'amenity/'.$row->icon?>" class="img-thumbnail" alt="<?=$row->name?>" style="width: 75px; height: 75px; margin-top: 10px;">
                    <?php } else {?>
...
</section><?php /**PATH E:\xampp8.2\htdocs\relook\resources\views/admin/maincontents/amenity/list.blade.php ENDPATH**/ ?>