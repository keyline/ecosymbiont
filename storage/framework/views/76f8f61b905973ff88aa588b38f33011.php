...
<body>
    <ul class="header">
        <li style="float: left; width: 70%;">
            ...
            <p style="font-size: 12px; line-height: 2;">A <span><u>digitized form of a</u></span> <strong>hand-signed</strong> copy of this NELP must be uploaded to  (<span style="background: yellow;"><?=url('/')?></span>).</p>
            <h5>NON-EXCLUSIVE LICENSE TO PUBLISH (“NELP”)</h5>
        </li>
        <li style="float: right;">
            <!-- <img src="data:image/svg+xml;base64,<?php echo base64_encode(file_get_contents(base_path('public/material/frontend/assets/images/logo-pdf.png'))); ?>" alt="<?=$generalSetting->site_name?>" srcset="" style="max-width: 100%;width: 30%;"> -->
        </li>
    </ul>
    <ul style="padding: 0;">
        <li>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; padding: 5px 15px;">
                    <?=$creative_Work?><span style="display: block; margin-top: 5px; text-align: right;">(the <strong>“Contribution”</strong>)</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; padding: 5px 15px;">
                <?=$first_name?> <?=$middle_name?> <?=$last_name?> <span style="display: block; margin-top: 5px; text-align: right;">(the “<strong>Lead Author</strong>”)</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; padding: 5px 15px;">
                    <?php
                    $ecosystem_affiliationId    = json_decode($ecosystem_affiliationId);
                    $affiliations               = [];
                    if(!empty($ecosystem_affiliationId)){ for($k=0;$k<count($ecosystem_affiliationId);$k++){
            ...
            <tr>
                ...
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; padding: 5px 15px;"><?=$indigenous_affiliation?></td>
            </tr>
            <tr>
                ...
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; padding: 5px 15px;"><?=$organization_name?></td>
            </tr>
            <tr>
                ...
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; padding: 5px 15px;">
                    <?php
                    $getCountry = Country::select('name')->where('id', '=', $country)->first();
            ...
            <tr>
                <td width="20%" valign="top" style="border: 1px solid #000; border-top: none; border-right: none; background: #e7e6e6; padding: 5px 15px;"></td>
                <td width="20%" valign="top" style="border: 1px solid #000; border-top: none; border-right: none; background: #e7e6e6; padding: 5px 15px;"></td>
                <td width="20%" valign="top" style="border: 1px solid #000; border-top: none; border-right: none; background: #e7e6e6; padding: 5px 15px;"></td>
                <td width="20%" valign="top" style="border: 1px solid #000; border-top: none; border-right: none; background: #e7e6e6; padding: 5px 15px;"></td>
                <td width="20%" valign="top" style="border: 1px solid #000; border-top: none; background: #e7e6e6; padding: 5px 15px;"></td>
                <td width="20%" valign="top" style="border: 1px solid #000; border-top: none; background: #e7e6e6; padding: 5px 15px;"></td>
            </tr>
            <tr>
                <td width="20%" valign="top" style="border: 1px solid #000; border-top: none; border-right: none; background: #e7e6e6; padding: 5px 15px;"></td>
...
</html><?php /**PATH G:\xampp8.2\htdocs\ecosymbiont\resources\views/email-templates/nelp-form.blade.php ENDPATH**/ ?>