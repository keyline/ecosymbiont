          ...
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-10 col-lg-10">
                ...
                <?php if($id_proof != ''){?>
                  <a href="<?=env('UPLOADS_URL').'center/'.$id_proof?>" target="_blank" class="badge bg-primary" download>View File</a>
                <?php }?>
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-md-10 col-lg-10">
                ...
                <?php if($photo != ''){?>
                  <img src="<?=env('UPLOADS_URL').'center/'.$photo?>" alt="<?=$name?>" style="width: 150px; height: 150px; margin-top: 10px; border-radius: 50%;">
                <?php } else {?>
...
</script><?php /**PATH G:\xampp8.2\htdocs\kids-zone\resources\views/admin/maincontents/center/add-edit.blade.php ENDPATH**/ ?>