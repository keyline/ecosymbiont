			    ...
			    <table class="table table-bordered">
			        <thead class="thead-dark">
			            <tr>
			                ...
			                <th style="" colspan="2">Amount</th>
			            </tr>
			        </thead>
			        <tbody>
			            <tr >
			                <td style="">08.10.2023</td>
			                <td style="">October, 2023</td>
			                <td style="text-align: center;">**** **** **** 1234</td>
			                <td style="text-align: center;">$2500</td>
			                <td style="text-align: center;"><a href="#" class="theme-btn download-btn">Download Receipt
			                    </a>
			                </td>
			            </tr>
			            <tr >
...
<!-- / Content --><?php /**PATH G:\xampp8.2\htdocs\qarp\resources\views/front/pages/user/payment-history.blade.php ENDPATH**/ ?>