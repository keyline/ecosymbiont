                ...
                <tr>
                  ...
                  <td>
                    <?php if($row->cover_image != ''){?>
                      <img src="<?=env('UPLOADS_URL').'restaurant/'.$row->cover_image?>" class="img-thumbnail" alt="<?=$row->name?>" style="width: 150px; height: 150px; margin-top: 10px;">
                    <?php } else {?>
...
</section><?php /**PATH E:\xampp8.2\htdocs\relook\resources\views/admin/maincontents/restaurant-category/list.blade.php ENDPATH**/ ?>