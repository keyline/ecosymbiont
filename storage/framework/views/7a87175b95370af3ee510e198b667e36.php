        ...
        <div class="card-body">
          ...
          <?php if($row){?>
            <table class="table table-striped">
              ...
              <tr>
                <th>Base Rent Value</th>
                <td><?=$row->base_rent_val?></td>
              </tr>
              <tr>
                <th>Term</th>
                <td><?=$row->term?></td>
...
</section><?php /**PATH G:\xampp8.2\htdocs\qarp\resources\views/admin/maincontents/lead/details.blade.php ENDPATH**/ ?>