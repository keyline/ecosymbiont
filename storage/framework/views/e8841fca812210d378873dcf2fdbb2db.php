  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('admin/settings')); ?>">
...
</nav><!-- End Icons Navigation --><?php /**PATH E:\xampp8.2\htdocs\stumento\resources\views/admin/elements/header.blade.php ENDPATH**/ ?>