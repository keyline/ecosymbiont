                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="post-content">
                                            ...
                                            <?php if($button_show){?>
                                                ...
                                                <?php } else {?>
                                                    <p class="text-center"><a href="<?=url('signin')?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Submit New Article</a></p>
                                                <?php }?>
                                            <?php }?>
                                        </div>
                                    </div>
...
<!-- End block-wrapper-section --><?php /**PATH G:\xampp8.2\htdocs\ecosymbiont\resources\views/front/pages/page-content.blade.php ENDPATH**/ ?>