<!-- ========== MAIN CONTENT ========== -->
      ...
      <div class="mx-auto" style="max-width: 30rem;">
                ...
                <!-- <div class="d-grid mb-4">
                  <a class="btn btn-white btn-lg" href="#">
                    <span class="d-flex justify-content-center align-items-center">
                      <img class="avatar avatar-xss me-2" src="<?=env('ADMIN_ASSETS_URL')?>assets/svg/brands/google-icon.svg" alt="Image Description">
                      Sign in with Google
                    </span>
                  </a>
                </div>
        ...
        <div class="position-relative text-center zi-1">
          <small class="text-cap text-body mb-4">
            Developed & maintained by <a target="_blank" href="https://itiffyconsultants.com/">Itiffy Consultants</a>
          </small>
        </div>
        <!-- End Footer -->
      </div>
  ...
  <!-- ========== END MAIN CONTENT ========== --><?php /**PATH G:\xampp8.2\htdocs\screen_2_crush\resources\views/admin/maincontents/change-password.blade.php ENDPATH**/ ?>