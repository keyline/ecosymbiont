          ...
          <div class="card mb-3">
            <div class="card-body">
              ...
              <form method="POST" action="" class="row g-3">
                ...
                <div class="col-12">
                  <p class="small mb-0">Forgot Password? <a href="<?php echo e(url('/admin/forgot-password')); ?>">Click Here</a></p>
                </div>
              </form>
            </div>
          </div>
          <div class="credits">
            Designed by <a target="_blank" href="https://itiffyconsultants.com/">Itiffy Consultants</a>
          </div>
        </div>
      </div>
    </div>
  </section>
</div><?php /**PATH G:\xampp8.2\htdocs\qarp\resources\views/admin/maincontents/signin.blade.php ENDPATH**/ ?>