      ...
      <div class="card">
        <div class="card-body pt-3">
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              <label for="link" class="col-md-2 col-lg-2 col-form-label">Link</label>
              <div class="col-md-10 col-lg-10">
...
</section><?php /**PATH G:\xampp8.2\htdocs\qarp\resources\views/admin/maincontents/home-page-section2/add-edit.blade.php ENDPATH**/ ?>