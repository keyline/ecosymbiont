                        ...
                        <div class="shop-tab">
                           <ul class="nav" role="tablist" id="dz-shop-tab">
                              <li class="nav-item" role="presentation">
                                 <a href="<?=url('new-products-list')?>" class="nav-link" id="tab-list-list-btn" data-bs-toggle="pill"
                              ...
                              <li class="nav-item" role="presentation">
                                 <a href="<?=url('new-products-grid')?>" class="nav-link" id="tab-list-grid-btn"
...
</section><?php /**PATH G:\xampp8.2\htdocs\screen_2_crush\resources\views/front/pages/sell-products-list.blade.php ENDPATH**/ ?>