                        ...
                        <div class="shop-tab">
                           <ul class="nav" role="tablist" id="dz-shop-tab">
                              <li class="nav-item" role="presentation">
                                 <a href="<?=url('used-products-list')?>" class="nav-link" aria-controls="tab-list-list" aria-selected="true">
                                    <i class="fa-solid fa-list"></i>List View
                                 </a>
                              </li>
                              <li class="nav-item" role="presentation">
                                 <a href="<?=url('used-products-grid')?>" class="nav-link" aria-controls="tab-list-grid" aria-selected="false">
                                    <i>
...
</script><?php /**PATH G:\xampp8.2\htdocs\screen_2_crush\resources\views/front/pages/used-products-grid.blade.php ENDPATH**/ ?>