                ...
                <tr>
                  ...
                  <td>
                    <ul class="list-group">
                      ...
                      if(!empty($type_allowed)){
                        for($i=0;$i<count($type_allowed);$i++){
                        ?>
                        <li class="list-group-item"><i class="fa fa-check-circle text-success"></i> <?=$type_allowed[$i]?></li>
                        <?php }
                      }
                      ?>
                    </ul>
...
</section><?php /**PATH G:\xampp8.2\htdocs\qarp\resources\views/admin/maincontents/landlord-document-type/list.blade.php ENDPATH**/ ?>