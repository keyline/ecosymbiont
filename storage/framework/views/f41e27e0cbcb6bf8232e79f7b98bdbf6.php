            ...
            <div class="tab-pane fade pt-3" id="tab4">
              ...
              <form method="POST" action="<?php echo e(url('admin/email-settings')); ?>" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <h3>Test Email</h3>
                <a href="<?php echo e(url('admin/test-email')); ?>" class="btn btn-success"><i class="fa fa-envelope"></i> Click To Send Test Email</a>
                </div>
                <div class="text-center">
                  <button type="submit" class="btn btn-primary">Submit</button>
                </div>
...
<!-- Script --><?php /**PATH G:\xampp8.2\htdocs\ecosymbiont\resources\views/admin/maincontents/settings.blade.php ENDPATH**/ ?>