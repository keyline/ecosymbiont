          ...
          <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header bg-dark text-light">
                    <h4 class="text-light">Basic Information</h4>
                  </div>
                  <div class="card-body">
                    <div class="row mb-3">
            ...
            <div class="row mb-3">
              <div class="col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header bg-dark text-light">
                    <h4 class="text-light">Engine and Components (Non-mandatory for scraping)</h4>
                  </div>
                  <div class="card-body">
                    <div class="row mb-3">
                      <div class="col-md-6 col-lg-6">
            ...
            <div class="row mb-3">
              <div class="col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header bg-dark text-light">
                    <h4 class="text-light">Drivetrain and Mechanical (Non-mandatory for scraping)</h4>
                  </div>
                  <div class="card-body">
                    <div class="row mb-3">
                      <div class="col-md-6 col-lg-6">
            ...
            <div class="row mb-3">
              <div class="col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header bg-dark text-light">
                    <h4 class="text-light">Hydraulics (Non-mandatory for scraping)</h4>
                  </div>
                  <div class="card-body">
                    <div class="row mb-3">
                      <div class="col-md-6 col-lg-6">
            ...
            <div class="row mb-3">
              <div class="col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header bg-dark text-light">
                    <h4 class="text-light">Body (Non-mandatory for scraping)</h4>
                  </div>
                  <div class="card-body">
                    <div class="row mb-3">
                      <div class="col-md-6 col-lg-6">
            ...
            <div class="row mb-3">
              <div class="col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header bg-dark text-light">
                    <h4 class="text-light">Other Information</h4>
                  </div>
                  <div class="card-body">
                    <div class="row mb-3">
                      <div class="col-md-12 col-lg-12">
                        <label for="addl_info">Additional Information </label>
                        <textarea name="addl_info" class="form-control ckeditor" id="addl_info" required rows="5"><?=$addl_info?></textarea>
                      </div>
                      <div class="col-md-6 col-lg-6">
                          ...
                          <?php if($listing_id > 0){?>
                            ...
                            ?>
                              <div class="col-md-2">
                                ...
                                <a href="<?=url('admin/' . $controllerRoute . '/delete-single-image/'.Helper::encoded($product_other_image->id).'/'.Helper::encoded($listing_id))?>" class="btn btn-danger btn-sm" onclick="return confirm('Do You Want To Delete This Image ?')"><i class="fa fa-trash"></i> Delete</a>
                              </div>
                            <?php } } else {?>
                              <img src="<?=env('NO_IMAGE')?>" alt="<?=$model?>" class="img-thumbnail" style="width: 150px; height: 150px; margin-top: 10px;">
                            <?php }?>
            ...
            <div class="row mb-3">
              <div class="col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header bg-dark text-light">
                    <h4 class="text-light">Related Documents</h4>
                  </div>
                  <div class="card-body">
...
</script><?php /**PATH G:\xampp8.2\htdocs\screen_2_crush\resources\views/admin/maincontents/listing-ad/add-edit.blade.php ENDPATH**/ ?>