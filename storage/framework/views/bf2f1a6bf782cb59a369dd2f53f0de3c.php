          ...
          <table class="table datatable">
            <thead>
              <tr>
                ...
                <th scope="col">TAT<br><small>(Turn Around Time) [In Minutes]</small></th>
            ...
            <tbody>
              <?php if($rows){ $sl=1; foreach($rows as $row){?>
                <tr>
                  ...
                  <td>
                    <?php
                    $category                 = RestaurantCategory::select('name')->where('id', '=', $row->category)->first();
...
</section><?php /**PATH E:\xampp8.2\htdocs\relook\resources\views/admin/maincontents/restaurant-item/list.blade.php ENDPATH**/ ?>