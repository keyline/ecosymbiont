                              ...
                              <div class="Property-estimate">
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="price-select child-tenan ">
                                          ...
                                          <input type="radio" name="child_tenant_check" id="child_tenant_check1" value="1" required> <label for="child_tenant_check1" style="margin:0;margin-left:8px;margin-right:8px;">Yes</label>
                                          <input type="radio" name="child_tenant_check" id="child_tenant_check2" value="0" required> <label for="child_tenant_check2" style="margin:0;margin-left:8px;">No</label>
                                 ...
                                 <div class="pets-blocks">
                                    <div class="col-md-12 ">
                                       <div class=" d-flex justify-content-center align-items-center ">
                                          <h3>PETS</h3>
                                          <input type="radio" name="pet_check" id="pet_check1" value="1" style="margin-right: 8px;" required> <label for="pet_check1" style="margin: 0;margin-right:8px;">Yes</label>
                                          <input type="radio" name="pet_check" id="pet_check2" value="0" style="margin-right: 8px;" required> <label for="pet_check2" style="margin: 0;">No</label>
                                 ...
                                 <div class="pets-blocks Parking-block ">
                                    <div class="col-md-12">
                                       <div class="d-flex justify-content-center align-items-center ">
                                          <h3>Parking</h3>
                                          <input type="radio" name="parking_check" id="parking_check1" value="1" style="margin-right: 8px;" required> <label for="parking_check1" style="margin: 0;margin-right:8px;">Yes</label>
                                          <input type="radio" name="parking_check" id="parking_check2" value="0" style="margin-right: 8px;" required> <label for="parking_check2" style="margin: 0;">No</label>
                                       </div>
                                 ...
                                 <div class="pets-blocks furnishing-section">
                                    <div class="col-md-12 ">
                                       <div class="d-flex justify-content-center align-items-center ">
                                          <h3>Furnishing</h3>
                                          <input type="radio" name="furniture_check" id="furniture_check1" value="1" style="margin-right: 8px;" required> <label for="furniture_check1" style="margin: 0;margin-right:8px;">Yes</label>
                                          <input type="radio" name="furniture_check" id="furniture_check2" value="0" style="margin-right: 8px;" required> <label for="furniture_check2" style="margin: 0;">No</label>
                                       </div>
                                 ...
                                 <div class="pets-blocks furnishing-section storage-section">
                                    <div class="col-md-12  ">
                                       <div class=" d-flex justify-content-center align-items-center ">
                                          <h3>Storage</h3>
                                          <input type="radio" name="storage_check" id="storage_check1" value="1" style="margin-right: 8px;" required> <label for="storage_check1" style="margin: 0;margin-right:8px;">Yes</label>
                                          <input type="radio" name="storage_check" id="storage_check2" value="0" style="margin-right: 8px;" required> <label for="storage_check2" style="margin: 0;">No</label>
                                       </div>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      $('#adult_tenant').on('change', function(){
         ...
         $('#base_rent').text(base_rent_val + (adult_dependent_nos * adult_pendent_rate));
...
</script><?php /**PATH G:\xampp8.2\htdocs\qarp\resources\views/front/pages/user/inquiry-form.blade.php ENDPATH**/ ?>