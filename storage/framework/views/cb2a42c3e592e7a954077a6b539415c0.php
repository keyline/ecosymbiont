            ...
            <tbody>
              <?php if($rows){ $sl=1; foreach($rows as $row){?>
                <tr>
                  ...
                  <td><a href="<?=$row->link?>" target="_blank" class="badge bg-info">View Link</a></td>
                  <td>
...
</section><?php /**PATH G:\xampp8.2\htdocs\qarp\resources\views/admin/maincontents/home-page-section2/list.blade.php ENDPATH**/ ?>