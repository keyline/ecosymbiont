                  ...
                  <tr>
                    ...
                    <td>
                      <ul>
                        ...
                        if(!empty($contact_persons)){ for($c=0;$c<count($contact_persons);$c++){
                        ?>
                          <li><?=$contact_persons[$c]?></li>
                        <?php } }?>
                      </ul>
                    </td>
                    <td><?=$row->email?></td>
...
</section><?php /**PATH G:\xampp8.2\htdocs\screen_2_crush\resources\views/admin/maincontents/source/list.blade.php ENDPATH**/ ?>