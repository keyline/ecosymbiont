        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <div class="about-left">
                    ...
                    <a href="<?= url('archieve') ?>" class="achive">Archive</a>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="journal_items">
                    ...
                    <div class="postdate_pdf">
                        <div class="journal_pdf"><a target="_blank"
                                href="<?= env('UPLOADS_URL') . 'notice/' . $row->notice_file ?>">View <i
                                    class="fa-solid fa-file-pdf"></i></a></div>
                    </div>
...
<?php /**PATH /home/keyline1/public_html/dev/aliahjournal.keylines.net.in/resources/views/front/pages/home.blade.php ENDPATH**/ ?>