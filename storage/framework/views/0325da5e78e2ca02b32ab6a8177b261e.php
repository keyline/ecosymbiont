<!-- block-wrapper-section ================================================== -->
    ...
    <div id="popup" style="position: fixed;top: 40%;left: 43%;width: 300px;padding: 20px;background-color: #d09c1c;border: 1px solid rgb(0, 0, 0);">
...
<!-- End block-wrapper-section --><?php /**PATH G:\xampp8.2\htdocs\ecosymbiont\resources\views/front/pages/signup.blade.php ENDPATH**/ ?>