<!-- ========== MAIN CONTENT ========== -->
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="position-relative text-center zi-1">
          <small class="text-cap text-body mb-4">
            Design & Developed by <a target="_blank" href="https://keylines.net/">KEYLINE</a>
          </small>
        </div>
        <!-- End Footer -->
      </div>
  ...
  <!-- ========== END MAIN CONTENT ========== --><?php /**PATH /home/keyline1/public_html/dev/aliahjournal.keylines.net.in/resources/views/admin/maincontents/signin.blade.php ENDPATH**/ ?>