                ...
                <?php if(count($rows)>0){ $sl=1; foreach($rows as $row){?>
                  <tr>
                    ...
                    <td>
                      ...
                      echo (($getListing)?$getListing->name:'');
                      ?>
                    </td>
                    <td><?=$row->product_info?></td>
                    <td>
                      <?php
                      $getReason = ReportListingReason::where('id', '=', $row->reason_id)->first();
                      echo (($getReason)?$getReason->name:'');
                      ?>
                    </td>
                    <td><?=wordwrap($row->message,35,"<br>\n")?></td>
                    <td>
...
</section><?php /**PATH G:\xampp8.2\htdocs\screen_2_crush\resources\views/admin/maincontents/listing-ad-report-inquiry/list.blade.php ENDPATH**/ ?>