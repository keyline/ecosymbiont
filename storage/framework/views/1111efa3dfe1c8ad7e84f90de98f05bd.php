                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($row->notice_file != ''){?>
                        <a href="<?=env('UPLOADS_URL').'notice/'.$row->notice_file?>" target="_blank" class="badge bg-primary">View Notice</a>
                      <?php }?>
                    </td>
                    <td>
...
</section><?php /**PATH G:\xampp8.2\htdocs\aliah-journal\resources\views/admin/maincontents/notice/list.blade.php ENDPATH**/ ?>