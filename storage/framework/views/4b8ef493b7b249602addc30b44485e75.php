                ...
                <div class="card-body pt-3">
                    <form method="POST" action="" enctype="multipart/form-data" oninput="validateForm()">
                            ...
                            <div class="col-md-10 col-lg-8">                                
                                <?php if($user_title): ?>
                                    <?php $__currentLoopData = $user_title; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <input type="radio" id="yes" name="title" value="<?php echo e($data->id); ?>"  <?php if($data->id == $titleId): echo 'checked'; endif; ?> >
                            ...
                            <div class="col-md-10 col-lg-8">                                                                
                                <?php if($pronoun): ?>
                                    <?php $__currentLoopData = $pronoun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <input type="radio" id="yes" name="pronoun" value="<?php echo e($data->id); ?>" <?php if($data->id == $pronounId): echo 'checked'; endif; ?> >
                                        <label for="yes"><?php echo e($data->name); ?></label>
                                            <!-- <?php echo e($data->name); ?></option> -->
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>                                
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10 col-lg-8">
                                <input type="radio" id="yes" name="orginal_work" value="Yes" <?php if(old('orginal_work', $orginal_work) == 'Yes'): echo 'checked'; endif; ?>>
                                <label for="yes">Yes</label>
                                <input type="radio" id="no" name="orginal_work" value="No" <?php if(old('orginal_work', $orginal_work) == 'No'): echo 'checked'; endif; ?>>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10 col-lg-8">
                                <input type="radio" id="yes" name="copyright" value="Yes" <?php if(old('copyright', $copyright) == 'Yes'): echo 'checked'; endif; ?>>
                                <label for="yes">Yes</label>
                                <input type="radio" id="no" name="copyright" value="No" <?php if(old('copyright', $copyright) == 'No'): echo 'checked'; endif; ?>>
                                <label for="no">No</label>
                            </div>
                        </div>  
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10 col-lg-8">
                                <input type="radio" id="participated_yes" name="participated" value="Yes" <?php if(old('participated', $participated) == 'Yes'): echo 'checked'; endif; ?>>
                                <label for="yes">Yes</label>
                                <input type="radio" id="participated_no" name="participated" value="No" <?php if(old('participated', $participated) == 'No'): echo 'checked'; endif; ?>>
                                <label for="no">No</label>
                            </div>
                        </div> 
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10 col-lg-8">
                                    <?php if(!empty($section_ert)): ?>
                                        ...
                                        <input type="checkbox" name="section_ert[]" value="<?php echo e($data->id); ?>" <?php if(in_array($data->id, $section_ertId)): ?> checked <?php endif; ?>><?php echo e($data->name); ?><br>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>                                     
                                </div>
                            </div>     
                            ...
                            <div class="row mb-3">
                                ...
                                <?php if($submission_type): ?>
                                    <?php for($i = 0; $i < count($submission_type); $i++): ?>
                                        ...
                                        <input type="radio" name="submission_types" value="<?php echo $data->id ?>" <?php if($data->id == $submission_types): echo 'checked'; endif; ?>>
...
<?php /**PATH G:\xampp8.2\htdocs\ecosymbiont\resources\views/admin/maincontents/article/add-edit.blade.php ENDPATH**/ ?>