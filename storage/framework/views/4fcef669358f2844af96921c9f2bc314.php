              ...
              <tbody>
                <?php if(count($rows)>0){ $sl=1; foreach($rows as $row){?>
                  <tr>
                    ...
                    <td>
                      <?php if($row->logo != ''){?>
                        <img src="<?=env('UPLOADS_URL').'manufacturer/'.$row->logo?>" alt="<?=$row->name?>" style="width: 100px; height: 100px; margin-top: 10px;border-radius: 50%;">
                      <?php } else {?>
...
</section><?php /**PATH G:\xampp8.2\htdocs\screen_2_crush\resources\views/admin/maincontents/manufacturer/list.blade.php ENDPATH**/ ?>