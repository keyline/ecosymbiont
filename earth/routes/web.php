...
/* Front Panel */
    // before login
        ...
        Route::match(['get', 'post'], '/communities/schumacher-Wild', 'App\Http\Controllers\FrontController@schumacherWild');
        Route::match(['get', 'post'], '/communities/west-oakland-matters', 'App\Http\Controllers\FrontController@westoaklandmatters');
