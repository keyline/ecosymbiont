                                        ...
                                        <div class="post-content">
                                            ...
                                            <div class="titleto-inner">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>For Creative-Work type (B), you may submit up to five (5) art images of the same or related piece(s) of art. You must provide the following details about your piece(s) of art: (a) title, (b) medium (<i>e.g.</i>, oil on canvas), (c) dimensions, and (d) year created.</li>
                                            ...
                                            <div class="titleto-inner">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <strong><i>Ecoweb Regeneration</i></strong><br>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <strong><i>Art-Music-Performance</i></strong><br>
                                                                Visual art, literary art, and/or audiovisual media of music and/or performance.
                                                            </li>
                                                            <li>
                                                                <strong><i>Food Sovereignty</i></strong><br>
                                            ...
                                            <p class="text-center"><a href="<?=url()?>contact.php" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Submit New Creative-Work</a></p>
                                            <!-- <?php if($button_show){?>
