                                                ...
                                                <div class="item news-post video-post video_post_text">
                                                    ...
                                                    <?php } else {?>
                                                        <div class="video-post">
                                                            ...
                                                            ?php }?> -->
                                                            <!-- <a href="https://www.youtube.com/watch?v=?=$rowContent->videoId?>" class="video-link"><i class="fa fa-play-circle-o"></i></a> -->
                                                            <a href="<?=url('category/' . $alsoLikeContent->parent_category_slug. '/' . $alsoLikeContent->sub_category_slug)?>"><i class="fa fa-play-circle-o"></i></a>
                                                        </div>
                                                    <?php } ?>
                                                    <div class="hover-box">
                                                    ...
                                                    <div class="item news-post video-post video_post_text">
                                                        ...
                                                        <?php } else {?>
                                                            <div class="video-post">
                                                                ...
                                                                ?php }?> -->
                                                                <!-- <a href="https://www.youtube.com/watch?v=?=$other_articles_in_this_series_row->videoId?>" class="video-link"><i class="fa fa-play-circle-o"></i></a> -->
                                                                <a href="<?=url('category/' . $other_articles_in_this_series_row->parent_category_slug. '/' . $other_articles_in_this_series_row->sub_category_slug)?>"><i class="fa fa-play-circle-o"></i></a>
                                                            </div>
                                                        <?php } ?>
                                                        <div class="hover-box">
