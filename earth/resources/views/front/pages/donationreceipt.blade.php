                ...
                <div class="pdf-body">
                    <div class="receipt-card">
                        <div class="receipt-header-top">
                            <div class="logo-left">
                                <img style="width: 133px; height: 130px; margin-top: 5px" src="data:image/svg+xml;base64,<?php echo base64_encode(file_get_contents(base_path('public/uploads/pdf-logo.jpg'))); ?>">
                            </div>
                        ...
                        <div class="receipt-details">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><?=date_format(date_create($donation->payment_timestamp), "d F, Y")?></td>
                                </tr>
                                <tr>
