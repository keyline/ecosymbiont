                ...
                <div class="col-md-9 col-sm-8 content-blocker">
                    ...
                    <div class="block-content">
                        ...
                        <div class="article-box">
                            ...
                            // Query for the second-to-last article from each category
                                $categoryArticles = NewsContent::join('news_category as parent_category', 'news_contents.parent_category', '=', 'parent_category.id')
                                ->join('news_category as sub_category', 'news_contents.sub_category', '=', 'sub_category.id')
                                ->select(
                                    'news_contents.id',
                                    'news_contents.new_title',
                                ...
                                ") // Get second last article per category
                                ->get();

                                // Query for the first article from each series
                                ...
                                ->where('news_contents.series_article_no', 1) // Get the first article of each series
                                ->get();

                                // Merge both collections
                                $combinedArticles = $categoryArticles->merge($seriesArticles);

                                // Shuffle the merged results randomly
                                $shuffledArticles = $combinedArticles->shuffle();

                                // Limit the final result to 6 articles
                                $finalArticles = $shuffledArticles->take(6);
                            ...
                            if($finalArticles){ foreach($finalArticles as $recentContent){
                            ?>
                                <?php
                                $is_series                  = $recentContent->is_series;
                                $series_article_no          = $recentContent->series_article_no;
