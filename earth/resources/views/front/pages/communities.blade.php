                    ...
                    <div class="article-box">                            
                        ...
                        <div class="weave_communities">
                            ...
                            <div class="row" style="margin: 20px 0;">
                                <div class="col-md-2">
                                    <img src="<?=env('UPLOADS_URL').'EaRTh-Weave-Communities-Text-Logo.jpg'?>" alt="" style="width: 100%; max-width: 200px;">
                                </div>
                                <div class="col-md-10">
                                    <div class="titleto-inner">
                                        <ul>
                        ...
                        <div class="thrive_communities">
                            ...
                            <div class="row" style="margin: 20px 0;">
                                <div class="col-md-2">
                                    <img src="<?=env('UPLOADS_URL').'EaRTh-Thrive-Communities-Text-Logo.jpg'?>" alt="" style="width: 100%; max-width: 200px;">
                                </div>
                                <div class="col-md-10">
                                    <div class="titleto-inner">
                                        <ul>
