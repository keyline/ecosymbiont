                ...
                <div class="block-content">
                    <div class="article-box">                            
                        <div class="titleto-box">
                            ...
                            <h5 style="padding: 5px; border: 1px solid #000; text-align: center; font-weight: 600; margin: 25px 0 20px;">But that’s not all EaRTh is.</h5>
                        ...
                        <div class="weave_communities">
                            ...
                            <div class="row" style="margin: 20px 0;">
                                <div class="col-md-2">
                                    <img src="<?=env('UPLOADS_URL').'EaRTh-Weave-Communities-Text-Logo.jpg'?>" alt="" style="width: 100%; max-width: 400px;">
                                </div>
                                <div class="col-md-10">
                                    <div class="titleto-inner">
                                        <ul>
                        ...
                        <div class="thrive_communities">
                            ...
                            <div class="row" style="margin: 20px 0;">
                                <div class="col-md-2">
                                    <img src="<?=env('UPLOADS_URL').'EaRTh-Thrive-Communities-Text-Logo.jpg'?>" alt="" style="width: 100%; max-width: 400px;">
                                </div>
                                <div class="col-md-10">
                                    <div class="titleto-inner">
                                        <ul>
