          ...
          <div class="dt-responsive table-responsive">
            ...
            <table id="simpletable" class="table table-striped table-bordered nowrap">
              ...
              <?php for ($i = 0; $i < $max; $i++) { ?>
                <tr>
                  <th scope="row"><?= $i + 1 ?></th>
                  <td><?= isset($gallery[$i]) ? wordwrap($gallery[$i]->new_title, 30, "<br>") : '-' ?><hr class="my-1">
                  <?php
                  if(isset($gallery[$i])){
                  ...
                  <td><?= isset($featured[$i]) ? wordwrap($featured[$i]->new_title, 30, "<br>") : '-' ?><hr class="my-1">
                    <?php
                    if(isset($featured[$i])){
                  ...
                  <td><?= isset($projects[$i]) ? wordwrap($projects[$i]->new_title, 30, "<br>") : '-' ?><hr class="my-1">
                    <?php
                    if(isset($projects[$i])){
                  ...
                  <td><?= isset($interviews[$i]) ? wordwrap($interviews[$i]->new_title, 30, "<br>") : '-' ?><hr class="my-1">
                    <?php
                  ...
                  <td><?= isset($webinars[$i]) ? wordwrap($webinars[$i]->new_title, 30, "<br>") : '-' ?><hr class="my-1">
                    <?php
                    if(isset($webinars[$i])){
                  ...
                  <td><?= isset($video_content[$i]) ? wordwrap($video_content[$i]->new_title, 30, "<br>") : '-' ?><hr class="my-1">
                    <?php
                  ...
                  <td><?= isset($explore_projects[$i]) ? wordwrap($explore_projects[$i]->new_title, 30, "<br>") : '-' ?><hr class="my-1">
                    <?php
