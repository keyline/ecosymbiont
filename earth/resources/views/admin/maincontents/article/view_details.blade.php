              ...
              <table class="table table-striped table-bordered nowrap">
                ...
                <tbody>                
                    ...
                    <tr>
                      ...
                      <br><?=$art_video_file?><a href="<?=env('UPLOADS_URL').'art_video/'.$art_video_file?>" download="<?=$art_video_file?>" class="btn btn-outline-success btn-sm"><i class="fa fa-download"></i></a>
                      <?php }?>                      
                      </td>
                    </tr>
                    <tr>
