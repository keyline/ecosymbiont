  ...
  <body style="padding: 0; margin: 0;">
    <section style="padding: 80px 0; margin: 0 15px;">
        <div style="max-width: 900px; background: #ffffff; margin: 0 auto; border-radius: 15px; padding: 20px 15px; box-shadow: 0 0 30px -5px #ccc;">
          ...
          <div>
            <h3 style="text-align: center; font-size: 25px; color: #5c5b5b; font-family: sans-serif;">Completed Leads</h3>
            <table border="1" cellpadding="5" cellspacing="3" style="width: 900px;  border-spacing: 2px; margin-bottom: 10px; border-collapse: collapse;">
              <thead>
                <tr>
                  <th colspan="6" style="background: #2e3192; color: #fff; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px; text-align: center;">Not Filled Application Form</th>
                </tr>
                <tr>
                  <th style="background: #ccc; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Enquiry No.</th>
                  <th style="background: #ccc; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Name</th>
                  <th style="background: #ccc; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Email</th>
                  <th style="background: #ccc; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Phone</th>
                  <th style="background: #ccc; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Property</th>
                  <th style="background: #ccc; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Unit</th>
                </tr>
              </thead>
              <tbody>
                <?php if($applicationNotFilled){ foreach($applicationNotFilled as $row){?>
                  <tr>
            ...
            <table border="1" cellpadding="5" cellspacing="3" style="width: 900px;  border-spacing: 2px; margin-bottom: 10px; border-collapse: collapse;">
              <thead>
                <tr>
                  <th colspan="6" style="background: #2e3192; color: #fff; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px; text-align: center;">Filled Application Form</th>
                </tr>
                <tr>
                  <th style="background: #ccc; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Enquiry No.</th>
                  <th style="background: #ccc; color: #000; width: 30%; padding: 10px; text-align: left; font-family: sans-serif; font-size: 14px;">Name</th>
              ...
              <tbody>
                <?php if($applicationFilled){ foreach($applicationFilled as $row){?>
                  <tr>
                    <td style="padding: 10px; background: #fff; text-align: left; color: #000;font-family: sans-serif;font-size: 15px;"><?=$row['enquiry_no']?></td>
                    <td style="padding: 10px; background: #fff; text-align: left; color: #000;font-family: sans-serif;font-size: 15px;"><?=$row['first_name'].' '.$row['last_name']?></td>
                    <td style="padding: 10px; background: #fff; text-align: left; color: #000;font-family: sans-serif;font-size: 15px;"><?=$row['email']?></td>
