        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; padding: 5px 15px;">
                    [14 (note: this indicates the question number on the submission form; the answer should be pasted here)]<span style="display: block; text-align: right;">(the <strong>“Contribution”</strong>)</span>
                </td>
            </tr>
            <tr>
