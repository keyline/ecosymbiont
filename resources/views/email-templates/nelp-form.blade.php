...
<body>
    ...
    <ul style="padding: 0;">
        ...
        <li style="margin: 10px 0"><span style="margin-right: 10px">2.3</span>The Author hereby asserts his/her/their moral right always to be identified as the author of the Contribution in accordance with the provisions of applicable national and international copyright laws. </li>
        <li style="font-weight: bold; margin: 10px 0"><span style="margin-right: 10px">3.</span> UNDERTAKINGS AND REPRESENTATIONS </li>
        <li style="font-weight: bold; margin: 10px 0"><span style="margin-right: 10px">3.1.</span> The Author hereby undertakes and represents that: </li>
        <ul style="padding: 0; padding-left: 20px">
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.1.</span>each named Author has full authority and power to agree to this NELP;</li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.2.</span>the Lead Author has full authority to execute this NELP on behalf of the Author;</li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.3.</span>the Contribution is original and has not been previously published in whole or in part in any medium that has an exclusive license to publish the Contribution; </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.4.</span>the Contribution and any Supplementary Material contain nothing that infringes any existing copyright or license or any other intellectual property right of any third party; </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.5.</span>the Contribution and any Supplementary Material contain nothing that breaches a duty of confidentiality or discloses any private or personal information of any person without that person’s written consent; </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.6.</span>all statements contained in the Contribution and any Original SM purporting to be facts are true and any formula, instruction or equivalent contained therein will not, if followed accurately, cause any injury or damage to the user; </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.7.</span>the Contribution and any Supplementary Material do not contain any libelous or otherwise unlawful material, or any material which would harm the reputation of the Platform or the Publisher or the Proprietor; </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.8.</span>there are no actual or apparent conflicts of interest connected to the Contribution that have not previously been declared. A conflict of interest is understood to exist if an interest (financial or otherwise) exerts or appears to exert undue influence on the analysis or conclusions in the Contribution, the choice of subject matter, or in any other way that impedes or appears to impede the Author’s objectivity or independence;.</li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.9.</span>if the Contribution is in a vernacular language that is not English, an accurate English translation has been submitted and, if applicable, accurate English subtitles have been submitted; </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.10.</span>if a named Author is a representative of an ecoweb-rooted community or a movement, then that named Author is an authorized and accepted representative of the ecoweb-rooted community or the movement;</li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">3.1.11.</span>if a named Author has listed a Preferred name for publication that is different from the named Author’s Legal Name, then that named Author authorizes the use of the Preferred name for publication in association with the Contribution. </li>
        </ul>
        ...
        <ul style="padding: 0; padding-left: 20px">
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">4.1.1.</span>licenses to re-use said content throughout the world in all languages and in all forms and media have or will be obtained from the rights-holders; </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">4.1.2.</span>appropriate acknowledgement to the original source of all such materials has been made; and </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">4.1.3.</span>in the case of photographic/audio/video material, appropriate release forms have been obtained from the individual(s) whose likenesses are represented in the Contribution and/or Third-party SM, as applicable.</li>
        </ul>
        ...
        <ul style="padding: 0; padding-left: 20px">
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">5.1.</span>If this NELP, and/or any other document provided in connection with this NELP, is or has been translated into any language other than English, the English language version shall prevail. </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">5.2.</span>The information contained in this NELP will be held for record-keeping purposes. The names of the Author may be reproduced on the Platform and provided to print and online indexing and abstracting services and bibliographic databases. The Proprietor and the Publisher comply with applicable data protection and privacy laws in the collection, retention, storage, and use of personal data. </li>
        </ul>
        <li style="font-weight: bold; margin: 10px 0"><span style="margin-right: 10px">6.</span> ENTIRE AGREEMENT</li>
        <ul style="padding: 0; padding-left: 20px">
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">6.1.</span>This NELP is made between, and contains the entire agreement between, the Proprietor and the Author concerning the Contribution and supersedes all related prior agreements, arrangements and understandings (whether written or oral). No addition to or modification of any provision of this NELP shall be binding unless it is in writing and signed on behalf of the Publisher and the Author. </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">6.2.</span>The Author acknowledges and agrees that the Proprietor is responsible, at its discretion, for appointing ‘publisher(s)’ to fulfil all or part of the Proprietor’s and Publisher’s obligations under this NELP, provided that any new ‘publisher’ appointed by the Proprietor shall comply with the terms of this NELP. </li>
            <li style="margin: 10px 0"><b><span style="margin-right: 10px">6.3.</span><li style="margin: 10px 0"><b><span style="margin-right: 10px">6.2.</span>The Author acknowledges and agrees that the Proprietor is responsible, at its discretion, for appointing ‘publisher(s)’ to fulfil all or part of the Proprietor’s and Publisher’s obligations under this NELP, provided that any new ‘publisher’ appointed by the Proprietor shall comply with the terms of this NELP. </li></li>
        </ul>
    </ul>    
</body>
</html>