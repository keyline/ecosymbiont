        ...
        <tbody>
            ...
            <tr>
                <th width="100%" colspan="2">
                    <p style="width: 100%; border: 1px solid #000; background-color: #e7e6e6; padding: 5px 15px; text-align:left;">THE CREATIVE-WORK</p>
                </th>
            </tr>
            <tr>
                ...
                <td width="70%">
                    <p style="border: 1px solid #000; border-top: none; padding: 5px 15px; width: 100%;">
