...
<body>
    ...
    <table style="width: 100%; background: #fff;">
        <tbody>
            ...
            <tr>
                <td width="30%" colspan="2" colspan="1" valign="top" style="border: 1px solid #000; border-top: none; border-right: none; background: #e7e6e6; padding: 5px 15px; font-weight: bold">Full Legal Name:</td>
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; padding: 5px 15px;">
            ...
            <tr>
                ...
                <td width="70%" colspan="6" valign="top" style="border: 1px solid #000; border-top: none; background: #e7e6e6; padding: 5px 15px; font-weight: bold">Date:</td>
            </tr>
            ...
            <tr>
                ...
                <td width="20%">Ancestral continental ecoweb affiliation</td>
                <td width="20%">Ancestral regional ecoweb affiliation</td>
