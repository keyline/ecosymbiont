                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <?php } else {?>
                                                <div class="post-gallery video-post">
                                                    ...
                                                    <?php } else {?>
                                                        <a href="<?=url('sign-in/' . Helper::encoded($current_url))?>" style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: #ffffff;font-size: 30px;"><i class="fa fa-play-circle-o"></i></a>
                                                    <?php }?>
                                                </div>
                                            <?php } ?>
                                        </div>
